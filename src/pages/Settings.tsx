              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-3">
                  {["#10b981", "#3b82f6", "#8b5cf6", "#f59e0b", "#ef4444"].map((color) => (
                    <button
                      key={color}
                      className="w-8 h-8 rounded-full ring-2 ring-offset-2 ring-offset-background ring-transparent hover:ring-primary transition-all"
        ...
        <TabsContent value="company" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Update your business details and billing information
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid gap-4 md:grid-cols-2">
